...
try:
    ...
    from .prompts import triage_system_prompt, triage_user_prompt, agent_system_prompt_hitl_memory, default_triage_instructions, default_background, default_response_preferences, default_cal_preferences, MEMORY_UPDATE_INSTRUCTIONS, MEMORY_UPDATE_INSTRUCTIONS_REINFORCEMENT
...
if __name__ == "__main__":
    result = email_assistant.invoke({
        "messages": [
            ("email_assistant_hitl_memory_gmail", "Nguyentv14@fpt.com run success")
        ]
    })
