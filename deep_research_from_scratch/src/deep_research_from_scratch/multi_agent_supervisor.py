...
async def main():
    """Main execution function to run the research supervisor."""
    
    # Define the research brief
    research_brief = "What are the most promising new applications of Large Language Models (LLMs) in finance, and what are the primary risks associated with them?"
    ...
    print(f"Starting research for: '{research_brief}'\n")
